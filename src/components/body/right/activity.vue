    ...
    <div>
      <div class="activity-imgWrap">
        ...
        <div class="activity-img-des">
          <h5>108位冒险者，皖南川藏线等你来</h5>
          <p>皖南川藏线又称“江南天路，位于皖南318”。该公路线东起宁国市的青龙乡，西至泾县的蔡村镇，其最神秘精华路段全长120公里。</p>
        </div>
      </div>
      <div class="activity-desWrap">
        <p class="text-indent-2">在这个夏天，我们召集108位热爱户外的驴友，一起来到风景绝美的皖南川藏线，一起自驾度过这个难忘的夏日。</p>
        <table class="activity-info-tb">
          <tr>
            <td style="width:90px;"><span class="ng-colon-after">所剩名额</span></td>
            <td><span class="activity-highlight">38</span></td>
          </tr>
          <tr>
            <td><span class="ng-colon-after">活动倒计时</span></td>
            <td><span class="activity-highlight">56天14小时23分11秒</span></td>
          </tr>
        </table>
